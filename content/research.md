    ...
    content:
      ...
      text: |-
        <style>
          ...
          .rs-link { font-size: 0.85rem; font-weight: 600; color: #1565c0 !important; text-decoration: none !important; white-space: nowrap; }
          .rs-link:hover { text-decoration: underline !important; }
          .dark .rs-link { color: #64b5f6 !important; }
        </style>
        <div class="rs-wrap">
        ...
        <div class="rs-meta">August 2026 &middot; Under Review</div>
        </div>
        </div>
        </div>
    design:
